...
def astrology():
    try:
        ...
        recommendedLocations = getRecommendedLocations(birthChart, planetaryTransits, interests, destination_lat, destination_lng, destination)
...
def getRecommendedLocations(birthChart, planetaryTransits, interests, destination_lat, destination_lng, destination):
    score = 0
...
def calculateCareerScore(birthChart, planetaryTransits, destination_lat, destination_lng):
...
def calculateLoveScore(birthChart, planetaryTransits, destination_lat, destination_lng):
    cusps, ascmc = swe.houses(jd, destination_lat, destination_lng, b'A')
...
def calculateSpiritualGrowthScore(birthChart, planetaryTransits, destination_lat, destination_lng):
    cusps, ascmc = swe.houses(jd, destination_lat, destination_lng, b'A')
